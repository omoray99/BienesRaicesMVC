...
use Controllers\LoginContoller;
use MVC\Router;
...
// Login y y Autenticacion

/*$router->get('/login',[LoginContoller::class, 'login'] );
$router->post('/login',[LoginContoller::class, 'login'] );
$router->get('/logout',[LoginContoller::class, 'logout'] );*/

$router->get('/login', [LoginContoller::class, 'login' ]);
$router->post('/login', [LoginContoller::class, 'login' ]);
$router->get('/login', [LoginContoller::class, 'logout' ]);
