<main class="contenedor seccion">
        ...
        <form class="formulario" action="/contacto" method="POST">
            ...
            <fieldset>
                ...
                <input name="contacto" type="radio" value="telefono" id="contactar-telefono" name="contacto" required> 

                <label for="contactar-email">E-mail</label>
                <input name="contacto" type="radio" value="email" id="contactar-email" name="contacto" required> 
                </div>
